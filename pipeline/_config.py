...
#    * mutants.tar: tar file containing mutants that generated by a mutation analysis tool
...
#   - If you want to turn off warnings, please add `-w` option
SUT_COMPILE_FLAGS = "-std=gnu99 -m64 -O1 -Wno-all -Wextra -Wshadow -Wcast-align -Wwrite-strings -Wno-unused-parameter -fPIC"
...
HPC_WORK_PATH          = '/tmp/MOTIF/SUBJECT_NAME'
...
# REPORT_EMAIL = None
REPORT_EMAIL = "user.email@example.com"
SBATCH_PARAMETERS = ""
