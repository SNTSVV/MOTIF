...
##################################################################################
EXP_BASE ='./case_studies/SUBJECT_NAME'
...
SUT_COMPILE_FLAGS = "-std=gnu99 -m64 -O1 -Wall -Wextra -Wshadow -Wcast-align -Wwrite-strings -Wno-unused-parameter -fPIC"
...
#   - Used this list if COMPILE_SUT_CMDS is not None
#   - Default relative path(".") is the REPO_PATH
